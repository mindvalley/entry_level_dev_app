class MilestonesController < ApplicationController
  ...
  private
    ...
    def milestone_params
      params.require(:milestone).permit(:mobile, :web_client, :foundations, :servers, :project_management, :communication, :craft, :initiative, :career_development, :org_design, :wellbeing, :accomplishment, :mentorship, :evangelism, :recruiting, :community, :employee_id)
    end
end
